  ...
  "src/yaml-library.js"(exports2, module2) {
    ...
    module2.exports = {
      ...
      verifyProperty: function(propertyValue, required, propertyName, keys, failed2, warning, info2) {
        ...
        let badness = propertyName + " was not included or had no value specified. (Path: " + keys + " )";
        let missing = propertyValue === void 0 || propertyValue === null;
        let requiredSwitch = typeof required == "string" ? required : required && "REQUIRED" in required ? required["REQUIRED"] : REQUIRED.INFO;
        if (missing) {
