...
var require_yaml_library = __commonJS({
  "src/yaml-library.js"(exports2, module2) {
    ...
    module2.exports = {
      verifyProperty: function(propertyValue, required, propertyName, keys, failed2, warning, info2) {
        var badness = propertyName + " was not included or had no value specified. (Path: " + keys + " )";
        var missing = propertyValue === void 0 || propertyValue === null;
        ...
        for (schemaValue in recursedSchema) {
          if (typeof recursedSchema[schemaValue] == "string") {
            ...
            if (schemaValue == "listCheck") {
              ...
              if (docValue !== void 0 && docValue !== null) {
                for (child in docValue) {
                  for (property in recursedSchema[schemaValue]) {
                    ...
                    this.verifyProperty(tempDocValue, recursedSchema[schemaValue][property], property, tempKeys, failed2, warning, info2);
                  }
                }
              }
            } else {
              ...
              this.recurseIntoArray(recursedSchema[schemaValue], newKeys, schemaValue, failed2, warning, info2);
            }
          }
        }
      },
